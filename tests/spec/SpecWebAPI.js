require([
    ...
    describe('modules/WebAPI', function () {
        ...
        describe('search', function () {
            ...
            it('switches to jsonp for browsers that don\'t support CORS', function () {
                supportsCORSSpy.and.returnValue(false);
